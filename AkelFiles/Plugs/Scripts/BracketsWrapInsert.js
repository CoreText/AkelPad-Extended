...
function process()
{
	...
	var sNewLineFromSelected = sSelectedText.substr(0, 1).match(/\r/g);
	//var bNewLineStartSelected = (sNewLineFromSelected)? (sNewLineFromSelected[0] === "\r" ) : false;
	//nSelectedFirstSpacesCount = (bNewLineStartSelected)? 0 : nSelectedFirstSpacesCount;

	//AkelPad.MessageBox(0, "Text: "+ nSelectedFirstSpacesCount, WScript.ScriptName, 0 );
	//AkelPad.MessageBox(0, "Text: "+ bNewLineStartSelected, WScript.ScriptName, 0 );
